module.exports = function(grunt) {
     ...
     */
    grunt.registerTask('build', ['clean:build', 'html2js', 'jshint', 'sass:build', 'copy:build_assets', 'copy:build_app', 'copy:build_libs','index:build', 'karmaconfig', 'karma:continuous']);
